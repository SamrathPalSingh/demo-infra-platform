...
func settingsFor(kind string) (publishConfig, error) {
	...
	case "service":
		return publishConfig{
			...
			ContractID: "search", ContractName: "Search API", Owner: "search-team",
			Repository: "demo-service-search", Contact: "#team-search",
		}, nil
	case "platform":
		return publishConfig{
			...
			Observed:   []string{"infra/storage-class.yaml", "infra/network-state.yaml", "infra/cluster-security-defaults.yaml", "terraform/main.tf"},
